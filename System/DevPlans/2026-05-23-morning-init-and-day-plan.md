...
> [!important] Обязательно при реализации
> Использовать **skill creator из статьи Вастрика** (vas3k.club/post/31592) — упаковывать логику в переиспользуемые скиллы по методологии из статьи.
